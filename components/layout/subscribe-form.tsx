        ...
        {({ isSubmitting }) => (
          <Form className="flex relative gap-2 items-center">
            <div className="relative">
              ...
              <ErrorMessage name="email" component="div" className="absolute -bottom-5 left-0 text-xs text-red-700" />
            </div>
            ...
            {feedback && (
              <div
                className={`text-xs absolute -bottom-5 ${
                  feedback === t("successfully-subscribed") ? "text-green-600 right-0" : "text-red-700 left-0"
            ...
            <Button
              ...
              className="bg-main-color hover:bg-main-color absolute right-1 transform  text-white px-4 py-2 rounded-sm text-sm font-medium transition-colors duration-200">
